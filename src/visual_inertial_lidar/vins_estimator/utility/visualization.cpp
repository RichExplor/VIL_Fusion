...
ros::Publisher pub_point_cloud, pub_margin_cloud, pub_map_cloud;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_map_cloud = n.advertise<sensor_msgs::PointCloud2>("map_cloud", 1000);
...
// void pointToMap(PointType const *const p_in, PointType *const p_out, const Estimator &estimator)
// {
//     Eigen::Matrix3d Ril(RIC[0] * RCL[0]);
//     Eigen::Vector3d til = RIC[0] * TCL[0] + TIC[0];
//     Eigen::Quaterniond q_w_l(estimator.Rs[WINDOW_SIZE] * Ril);
//     Eigen::Vector3d t_w_l = estimator.Rs[WINDOW_SIZE] * til + estimator.Ps[WINDOW_SIZE];

//     Eigen::Vector3d p_curr(p_in->x, p_in->y, p_in->z);
//     Eigen::Vector3d p_world = q_w_l * p_curr + t_w_l;
//     p_out->x = p_world.x();
//     p_out->y = p_world.y();
//     p_out->z = p_world.z();
...
// void pubMapCloud(const Estimator &estimator, const pcl::PointCloud<PointType> &mapCloud,const std_msgs::Header &header)
// {
//     if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
//     {
//         pcl::PointCloud<PointType> mapCloudReg;
//         size_t cloudSize = mapCloud.size();
//         for(size_t i = 0; i < cloudSize; ++i)
//         {
//             PointType points;
//             pointToMap(&mapCloud.points[i], &points, estimator);
//             mapCloudReg.push_back(points);
//         }

//         sensor_msgs::PointCloud2 mapCloud_Msg;
//         mapCloud_Msg.header = header;
//         mapCloud_Msg.header.frame_id = "world";
//         pcl::toROSMsg(mapCloudReg, mapCloud_Msg);
//         pub_map_cloud.publish(mapCloud_Msg);
//     }
// }
